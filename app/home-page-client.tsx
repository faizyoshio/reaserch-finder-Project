  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main id="main-content" aria-busy={loading} className="flex-1 px-2 sm:px-4 py-4 sm:py-6 max-w-5xl mx-auto w-full">
        ...
        <h1 className="sr-only">ResearchAtlas search for journals, books, e-books, and open web sources</h1>
        {/* */}
        ...
        {showIntro && (
          <div className="glass rounded-2xl p-6 sm:p-8 mb-8 text-center animate-glass-in">
            ...
            <p className="text-xs sm:text-sm text-foreground/60 mt-2 mb-0">
              <Link href="/saved" className="underline underline-offset-4 hover:text-foreground">
                View saved sources
              </Link>
            </p>
          </div>
        ...
        {!loading && results.length > 0 && (
          <div>
            ...
            {/* */}
            <nav className="mb-4 text-sm text-foreground/50" aria-label="Breadcrumb">
